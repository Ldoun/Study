...
def define_argparser():
    ...
    p.add_argument('--cnn1d', action='store_true')
...
def main(config):
    ...
    if config.rnn is False and config.cnn is False and config.cnn1d is False:
    ...
    torch.save({
        ...
        'cnn1d': cnn_model.state_dict() if config.cnn1d else None,
        'config': config,
